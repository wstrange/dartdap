...
//      '(sn=Foo*)': SubstringFilter.rfc224("sn", initial: "Foo", any: "*"),
//      '(sn=*Foo)': SubstringFilter.rfc224("sn", any: "*", finalValue: "Foo"),
//      '(sn=*Foo*Baz*)': SubstringFilter.rfc224("sn", any: "*Foo*Baz*"),
//      '(!(sn=Foo*))':
//      Filter.not(SubstringFilter.rfc224("sn", initial: "Foo", any: "*")),
//      '(|(cn=Babs)(sn=Foo))' : Filter.or([babs,foo]),
//      '(sn~=Foo)' : Filter.approx("sn", "Foo"),
      ...
      '(&(cn=Babs)(|(cn=Babs)(sn=Foo)))':
          Filter.and( [babs, Filter.or([foo, Filter.equals("empId","1")])]),
